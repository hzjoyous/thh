...
func init() {
	c := base.Console{Signature: "o:directMapping", Description: "this is a directMapping", Handle: directMapping}
	commandList[c.Signature] = c
	c = base.Console{Signature: "o:fullJoin", Description: "this is a fullJoin", Handle: fullJoin}
	commandList[c.Signature] = c
	c = base.Console{Signature: "o:groupJoin", Description: "this is a groupJoin", Handle: groupJoin}
	commandList[c.Signature] = c

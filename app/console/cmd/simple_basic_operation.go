...
func init() {
	...
	appendCommand(&cobra.Command{Use: "p:Chan", Short: "", Run: practiceChan})
	appendCommand(&cobra.Command{Use: "p:Defer", Short: "", Run: practiceDefer})
	appendCommand(&cobra.Command{Use: "p:Context", Short: "", Run: practiceContext})
	appendCommand(&cobra.Command{Use: "p:Go", Short: "", Run: practiceGo})
	appendCommand(&cobra.Command{Use: "p:FuncCase1", Short: "", Run: practiceFuncCase1})
	appendCommand(&cobra.Command{Use: "p:GG", Short: "", Run: practiceGG})

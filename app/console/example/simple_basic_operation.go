...
func init() {
	appendCommand(&cobra.Command{Use: "practiceArrAndMap", Short: "", Run: practiceArrAndMap})
	appendCommand(&cobra.Command{Use: "bitCompute", Short: "", Run: bitCompute})
	appendCommand(&cobra.Command{Use: "algorithmEatFood", Short: "", Run: algorithmEatFood})
	appendCommand(&cobra.Command{Use: "practiceChan", Short: "", Run: practiceChan})
	appendCommand(&cobra.Command{Use: "practiceDefer", Short: "", Run: practiceDefer})
	appendCommand(&cobra.Command{Use: "practiceContext", Short: "", Run: practiceContext})
	appendCommand(&cobra.Command{Use: "practiceGo", Short: "", Run: practiceGo})
	appendCommand(&cobra.Command{Use: "practiceFuncCase1", Short: "", Run: practiceFuncCase1})
	appendCommand(&cobra.Command{Use: "practiceValidate", Short: "", Run: practiceValidate})
	appendCommand(&cobra.Command{Use: "practiceGG", Short: "", Run: practiceGG})
...
func bitCompute(cmd *cobra.Command, args []string) {
...
func practiceArrAndMap(cmd *cobra.Command, args []string) {
	var (
		intArr  [2]int
		intArr2 [2][2]int
		intArr3 []int
...
func practiceValidate(cmd *cobra.Command, args []string) {
...
func practiceGG(cmd *cobra.Command, args []string) {
	type Point struct {
		X, Y float64
	}

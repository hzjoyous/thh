...
func init() {
	appendCommand(&cobra.Command{Use: "practiceTimeFormat", Short: "", Run: practiceTimeFormat})
	appendCommand(&cobra.Command{Use: "practiceBigNumber", Short: "", Run: practiceBigNumber})
	appendCommand(&cobra.Command{Use: "practicePanic", Short: "", Run: practicePanic})
	appendCommand(&cobra.Command{Use: "practiceSyncOnce", Short: "", Run: practiceSyncOnce})
	appendCommand(&cobra.Command{Use: "practiceReg", Short: "", Run: practiceReg})
